...
--DEV0_INV_OWNER
CREATE USER DEV0_INV_OWNER IDENTIFIED BY DEV0_INV_OWNER DEFAULT TABLESPACE USERS TEMPORARY TABLESPACE temp QUOTA 5M ON system;
GRANT ALL PRIVILEGES TO DEV0_INV_OWNER;
--DEV0_PLAT_INVOWNER
CREATE USER DEV0_PLAT_INVOWNER IDENTIFIED BY DEV0_PLAT_INVOWNER DEFAULT TABLESPACE USERS TEMPORARY TABLESPACE temp QUOTA 5M ON system;
GRANT ALL PRIVILEGES TO DEV0_PLAT_INVOWNER;
-- DEV0_STG_INVOWNER
CREATE USER DEV0_STG_INVOWNER IDENTIFIED BY DEV0_STG_INVOWNER DEFAULT TABLESPACE USERS TEMPORARY TABLESPACE temp QUOTA 5M ON system;
GRANT ALL PRIVILEGES TO DEV0_STG_INVOWNER;